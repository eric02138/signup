...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('requestapp_service', (
            ...
            ('doc_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True)),
        ...
        db.create_table('requestapp_labgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('services', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['requestapp.Service'])),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('ad_group_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        ...
        db.create_unique('requestapp_labgroup_members', ['labgroup_id', 'request_id'])
    ...
    models = {
        ...
        'requestapp.labgroup': {
            ...
            'services': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['requestapp.Service']"})
        },
        'requestapp.rcuser': {
        ...
        'requestapp.request': {
            ...
            'services': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['requestapp.Service']", 'null': 'True'}),
        ...
        'requestapp.service': {
            ...
            'doc_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'})
        }
    }
