...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabGroup.pi_phone'
        db.alter_column('requestapp_labgroup', 'pi_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'LabGroup.pi_first_name'
        db.alter_column('requestapp_labgroup', 'pi_first_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'LabGroup.name'
        db.alter_column('requestapp_labgroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'LabGroup.pi_mailing_address'
        db.alter_column('requestapp_labgroup', 'pi_mailing_address', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))

        # Changing field 'LabGroup.pi_email'
        db.alter_column('requestapp_labgroup', 'pi_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'LabGroup.ad_group_name'
        db.alter_column('requestapp_labgroup', 'ad_group_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'LabGroup.pi_last_name'
        db.alter_column('requestapp_labgroup', 'pi_last_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'LabGroup.pi_phone'
        db.alter_column('requestapp_labgroup', 'pi_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20))

        # Changing field 'LabGroup.pi_first_name'
        db.alter_column('requestapp_labgroup', 'pi_first_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'LabGroup.name'
        db.alter_column('requestapp_labgroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'LabGroup.pi_mailing_address'
        db.alter_column('requestapp_labgroup', 'pi_mailing_address', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'LabGroup.pi_email'
        db.alter_column('requestapp_labgroup', 'pi_email', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'LabGroup.ad_group_name'
        db.alter_column('requestapp_labgroup', 'ad_group_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'LabGroup.pi_last_name'
        db.alter_column('requestapp_labgroup', 'pi_last_name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'requestapp.labgroup': {
            ...
            'pi_email': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '75', 'null': 'True'}),
            'pi_first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'}),
            'pi_last_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'}),
            'pi_mailing_address': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '250', 'null': 'True'}),
            'pi_phone': ('django.contrib.localflavor.us.models.PhoneNumberField', [], {'default': "''", 'max_length': '20', 'null': 'True'}),
