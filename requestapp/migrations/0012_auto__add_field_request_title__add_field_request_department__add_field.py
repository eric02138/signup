...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.title'
        db.add_column('requestapp_request', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Request.department'
        db.add_column('requestapp_request', 'department',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Request.pi_phone'
        db.add_column('requestapp_request', 'pi_phone',
                      self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'Request.pi_mailing_address'
        db.add_column('requestapp_request', 'pi_mailing_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.title'
        db.delete_column('requestapp_request', 'title')

        # Deleting field 'Request.department'
        db.delete_column('requestapp_request', 'department')

        # Deleting field 'Request.pi_phone'
        db.delete_column('requestapp_request', 'pi_phone')

        # Deleting field 'Request.pi_mailing_address'
        db.delete_column('requestapp_request', 'pi_mailing_address')
