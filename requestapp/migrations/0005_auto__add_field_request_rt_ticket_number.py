...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.rt_ticket_number'
        db.add_column('requestapp_request', 'rt_ticket_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.rt_ticket_number'
        db.delete_column('requestapp_request', 'rt_ticket_number')
