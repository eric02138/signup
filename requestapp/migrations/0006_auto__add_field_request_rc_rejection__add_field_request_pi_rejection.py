...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.rc_rejection'
        db.add_column('requestapp_request', 'rc_rejection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Request.pi_rejection'
        db.add_column('requestapp_request', 'pi_rejection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.rc_rejection'
        db.delete_column('requestapp_request', 'rc_rejection')

        # Deleting field 'Request.pi_rejection'
        db.delete_column('requestapp_request', 'pi_rejection')
