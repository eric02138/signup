...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstrumentsRequested'
        db.create_table('requestapp_instrumentsrequested', (
        ...
        db.send_create_signal('requestapp', ['InstrumentsRequested'])


    def backwards(self, orm):
        # Deleting model 'InstrumentsRequested'
        db.delete_table('requestapp_instrumentsrequested')
    ...
    models = {
        ...
        'requestapp.instrumentsrequested': {
            'Meta': {'object_name': 'InstrumentsRequested'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
