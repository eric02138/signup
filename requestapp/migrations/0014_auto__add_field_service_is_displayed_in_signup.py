...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.is_displayed_in_signup'
        db.add_column('requestapp_service', 'is_displayed_in_signup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.is_displayed_in_signup'
        db.delete_column('requestapp_service', 'is_displayed_in_signup')
